...
class="cursor-pointer transition-transform hover:translate-y-[-5px] duration-[0.5s]"

:fill="svg.fill" :width="svg.width" :height="svg.height" :stroke="svg.stroke" stroke-width="0.10016"   viewBox="0 0 16.00 16.00" id="register-16px" xmlns="http://www.w3.org/2000/svg"  transform="rotate(0)">
