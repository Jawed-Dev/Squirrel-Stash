...
<svg :width="svg.width" :height="svg.width" viewBox="0 0 24 24" :fill="svg.fill" xmlns="http://www.w3.org/2000/svg" stroke="none">

    <g id="SVGRepo_bgCarrier" stroke-width="0"/>

    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>

    <g id="SVGRepo_iconCarrier"> <rect :width="svg.width" :height="svg.width" :fill="'none'"/> 
        <path fill-rule="evenodd" 
            clip-rule="evenodd" d="M6 8C6 4.68629 8.68629 2 12 2C15.3137 2 18 4.68629 18 8C18 11.3137 15.3137 14 12 14C8.68629 14 6 11.3137 6 8Z" 
        :fill="svg.fill" /> 
