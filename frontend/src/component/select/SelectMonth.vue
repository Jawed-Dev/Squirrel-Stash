<template>
    <select @change="handleSelect($event)" class="w-[250px] pl-2 gradient-border text-white rounded-[3px] 
    bg-main-gradient shadow-black shadow-custom-main focus:outline-none font-light" name="month" id="month-select">
...
<script setup>
    import { isValidMonth } from '@/error/useValidFormat';
